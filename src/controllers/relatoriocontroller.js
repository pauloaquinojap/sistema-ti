...
const relatorioController = {
  // 1. Busca opções para preencher os filtros do Modal
  getOpcoesFiltros: async (req, res) => {
    try {
  ...
  // 2. Gera o Relatório Geral de Inventário com Filtros Avançados
  gerarRelatorioInventario: async (req, res) => {
    try {
  ...
  // 3. Gera Relatório de Manutenção
  gerarRelatorioManutencao: async (req, res) => {
    try {
